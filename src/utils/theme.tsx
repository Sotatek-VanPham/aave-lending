  ...
  return {
    ...
    palette: {
      ...
      background: {
        ...
        paper: getColor('#1A1A1C', '#1A1A1C'),
        surface: getColor('#FF4228', '#FF4228'),
        surface2: getColor('#2a2e3d', '#2a2e3d'),
        ...
        header: getColor('#FF4228', '#FF4228'),
        footer: getColor('#FF4228', '#FF4228'),
        disabled: getColor('#EAEBEF', '#EBEBEF14'),
      },
      divider: getColor('#383a45', '#383a45'),
      action: {
        active: getColor('#8E92A3', '#EBEBEF8F'),
        hover: getColor('#A5A8B6', '#A5A8B6'),
        selected: getColor('#EAEBEF', '#EBEBEF29'),
        disabled: getColor('#BBBECA', '#EBEBEF4D'),
        disabledBackground: getColor('#2a2e3d', '#2a2e3d'),
